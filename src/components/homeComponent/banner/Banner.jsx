...
import home1 from "../../../img/image.png";
import slider2 from "../../../img/home1.webp";
          ...
          <div>
            <div className="flex flex-col justify-center -mt-10 wrapper">
              <p className="text-2xl font-normal text-white">
                Namaste, welcome to the Farmer's Hub.
              </p>
              ...
              <div className="flex justify-center items-center mx-auto">
                <button
                  onClick={() => window.open("https://cropgear.myshopify.com/collections/all", "_blank")}
