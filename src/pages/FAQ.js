              ...
              <div class="w-full lg:w-1/2 px-4 py-2">
                <details class="mb-4">
                  ...
                  <span className="text-justify">
                    You can sell your Farm Equipment by listing it on Farmer's Hub
                    website .
                  </span>
                </details>
                <details class="mb-4">
                  ...
                  <span className="text-justify">
                    Listing on Farmer's Hub is quite easy. Just click on the
                ...
                <details class="mb-4">
                  ...
                  <span className="text-justify">
                    ...
                    Farmer's Hub website or mobile applications. Don’t forget
              ...
              <div class="w-full lg:w-1/2 px-4 py-2">
                <details class="mb-4">
                  ...
                  <span class="px-4 py-2 text-justify">
                    ...
                    providers are open to selling equipment on Farmer's Hub
                    with a fair deal.
                  </span>
                </details>
                <details class="mb-4">
                  <summary class="font-semibold  bg-gray-200 rounded-md py-2 px-4">
                    I don't have a website, Can I still sell on Farmer's Hub?
                  </summary>

                  <span class="px-4 py-2 text-justify">
                    You don't need a website to start selling on Farmer's Hub.
